        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg bg-hero-pattern h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>100.000.000VND</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
          ...
          {earningData.map((item) => (
            ...
            >
              ...
              <p className='mt-3'>
                ...
                <span className={`text-sm ml-2 text-${item.pcColor}`} style={{ color: item.pcColor }}>
                  {item.percentage}
                </span>
              </p>
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>9.300.000VND</span>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>2.300.000VND</span>
                </p>
